...
output "../../output/Metal Gear Solid Special Disc [U].iso", create
origin $000000; insert "../../isos/Metal Gear Solid Special Disc [J].iso" // Include Japanese Metal Gear Solid Special Disc ISO
